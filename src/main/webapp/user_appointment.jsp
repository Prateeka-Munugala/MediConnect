	...
	<div class="container p-3">
		<div class="row">
			<div class="col-md-6 p-5">
				<img alt="" src="img/appointment.jpg" height="500px" width="550px">
			</div>
					...
					<div class="card-body">
						...
						<form class="row g-3" action="appAppointment" method="post">
							...
							<c:if test="${empty userObj }">
								<a href="user_login.jsp" class="col-md-6 offset-md-3 btn bg-primary">Submit</a>
							</c:if>

							<c:if test="${not empty userObj }">
								<button class="col-md-6 offset-md-3 btn bg-primary">Submit</button>
							</c:if>
						</form>
					</div>
				</div>
